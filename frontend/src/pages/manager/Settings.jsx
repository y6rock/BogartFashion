    ...
    return (
      <div style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ textAlign: 'center', color: '#ccc' }}>Loading settings...</div>
        </div>
      </div>
    );
  }
          ...
          <form onSubmit={handleSubmit}>
            {activeTab === 'general' && (
              <div style={{ display: 'grid', gap: '20px' }}>
                <div>
                  <label style={{ display: 'block', marginBottom: '8px', color: '#fff' }}>Store Name</label>
                  <input
                    type="text"
                    name="storeName"
            ...
            {activeTab === 'currency' && (
              <div style={{ display: 'grid', gap: '20px' }}>
                <div>
                  <label style={{ display: 'block', marginBottom: '8px', color: '#fff' }}>Currency</label>
                  <select
                    name="currency"
                ...
                <div>
                  <label style={{ display: 'block', marginBottom: '8px', color: '#fff' }}>Tax Rate (%)</label>
                  <input
                    type="number"
                    name="taxRate"
            ...
            {activeTab === 'contact' && (
              <div style={{ display: 'grid', gap: '20px' }}>
                <div>
                  <label style={{ display: 'block', marginBottom: '8px', color: '#fff' }}>Contact Email</label>
                  <input
                    type="email"
                    name="contactEmail"
                ...
                <div>
                  <label style={{ display: 'block', marginBottom: '8px', color: '#fff' }}>Contact Phone</label>
                  <input
                    type="tel"
                    name="contactPhone"
